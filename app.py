...
def title_v1(slide, data, P):
    ...
    txt(slide, data.get('title',''), 600000, 2200000, W-1200000, 1500000, size=54, bold=True, color='FFFFFF', align=PP_ALIGN.CENTER)
    if data.get('subtitle'): txt(slide, data['subtitle'], 600000, 3900000, W-1200000, 700000, size=22, color=P['secondary'], italic=True, align=PP_ALIGN.CENTER)
...
def title_v2(slide, data, P):
    ...
    txt(slide, data.get('title',''), 200000, 1700000, W//2-400000, 1800000, size=42, bold=True, color='FFFFFF')
    if data.get('subtitle'): txt(slide, data['subtitle'], 200000, 3700000, W//2-400000, 800000, size=18, color='E0D7FF', italic=True)
...
def title_v3(slide, data, P):
    ...
    txt(slide, data.get('title',''), 400000, 1700000, W-800000, 1500000, size=52, bold=True, color=P['dark'], align=PP_ALIGN.CENTER)
    if data.get('subtitle'): txt(slide, data['subtitle'], 400000, H-1600000, W-800000, 600000, size=20, color='FFFFFF', italic=True, align=PP_ALIGN.CENTER)
...
def title_v4(slide, data, P):
    ...
    txt(slide, data.get('title',''), 500000, 1500000, W-1000000, 1500000, size=48, bold=True, color='FFFFFF')
    if data.get('subtitle'): txt(slide, data['subtitle'], 500000, H//2+200000, W-1000000, 700000, size=20, color=P['secondary'], italic=True)
...
def problem_v1(slide, data, P):
    ...
    txt(slide, data.get('title',''), 200000, 1300000, 2600000, 800000, size=28, bold=True, color='FFFFFF')
...
def problem_v2(slide, data, P):
    ...
    txt(slide, data.get('title',''), 1100000, 320000, W-1400000, 700000, size=30, bold=True, color='FFFFFF')
...
def problem_v3(slide, data, P):
    ...
    txt(slide, data.get('title',''), 1200000, 320000, W-1600000, 700000, size=30, bold=True, color='FFFFFF')
    items = data.get('content', [])
...
def problem_v4(slide, data, P):
    ...
    txt(slide, data.get('title',''), 1050000, 280000, W-1400000, 650000, size=28, bold=True, color=P['dark'])
...
def solution_v1(slide, data, P):
    ...
    txt(slide, data.get('title',''), 1100000, 300000, W-1500000, 700000, size=30, bold=True, color='FFFFFF')
...
def how_v1(slide, data, P):
    ...
    if data.get('emoji'): txt(slide, data['emoji'], 300000, 250000, 650000, 650000, size=30)
    txt(slide, data.get('title',''), 1050000, 280000, W-1400000, 650000, size=28, bold=True, color=P['dark'])
    steps = data.get('steps') or data.get('content', [])
    n = min(len(steps), 4)
    if not n: return
...
def how_v4(slide, data, P):
    ...
    rect(slide, 0, 0, W, 1300000, P['primary'])
    if data.get('emoji'): txt(slide, data['emoji'], 300000, 280000, 700000, 700000, size=34)
    txt(slide, data.get('title',''), 1100000, 320000, W-1500000, 650000, size=28, bold=True, color='FFFFFF')
    steps = data.get('steps') or data.get('content', [])
    cw = (W-700000)//2
    ch = (H-1800000)//2
    gap = 200000
...
def impact_v1(slide, data, P):
    ...
    txt(slide, data.get('title',''), 1050000, 320000, W-1400000, 600000, size=28, bold=True, color=P['dark'])
...
def demo_v1(slide, data, P):
    ...
    txt(slide, data.get('title',''), 1050000, 300000, W-1400000, 600000, size=28, bold=True, color='FFFFFF')
...
def team_v1(slide, data, P):
    ...
    txt(slide, data.get('title',''), 1100000, 350000, W-1400000, 600000, size=30, bold=True, color='FFFFFF')
...
def closing_v1(slide, data, P):
    ...
    if data.get('subtitle'): txt(slide, data['subtitle'], 457200, 3500000, W-914400, 600000, size=20, color=P['secondary'], italic=True, align=PP_ALIGN.CENTER)
...
def closing_v2(slide, data, P):
    ...
    if data.get('subtitle'): txt(slide, data['subtitle'], 457200, H-1700000, W-914400, 700000, size=22, color=P['secondary'], italic=True, align=PP_ALIGN.CENTER)
...
def closing_v3(slide, data, P):
    ...
    if data.get('subtitle'): txt(slide, data['subtitle'], 457200, 3400000, W-914400, 700000, size=20, color=P['primary'], italic=True, align=PP_ALIGN.CENTER)
...
def build_slide(slide, data, palette, variants_map):
    ...
    if variants:
        ...
        txt(slide, data.get('title',''), 300000, 280000, W-600000, 650000, size=28, bold=True, color=palette['dark'])
        if data.get('content'):
